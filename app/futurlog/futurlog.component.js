...
var entry_futurlog_service_1 = require('../service/entry.futurlog.service');
...
var FuturLogComponent = (function () {
    function FuturLogComponent(EntryFuturLogService, EntryService, EntrySupplementService) {
        this.EntryFuturLogService = EntryFuturLogService;
    ...
    FuturLogComponent.prototype.getEntriesSupplement = function () {
        var _this = this;
    ...
    FuturLogComponent.prototype.showDay = function (day) {
        if (day < 10)
            return '0' + day;
        return day.toString();
    };
    FuturLogComponent = __decorate([
        ...
        __metadata('design:paramtypes', [entry_futurlog_service_1.EntryFuturLogService, entry_service_1.EntryService, entry_supplement_service_1.EntrySupplementService])
    ], FuturLogComponent);
